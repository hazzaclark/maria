...
namespace maria
{
    class EMITTER
    {
        public: 
            ...
            void SH2_MOV(U32 IMM, GP_REGISTER RN) noexcept;
            void SH2_MOVB(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVB_DISP(U8 DISP, GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVB_IND(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVB_IND_DEC(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVB_IND_INC(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVB_IND_R0(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVB_R0_IND(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVI(U8 IMM, GP_REGISTER RN) noexcept;
            void SH2_MOVL(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVL_DISP(U8 DISP, GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVL_IND(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVL_IND_DEC(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVL_IND_INC(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVL_IND_R0(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVL_R0_IND(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVT(GP_REGISTER RN) noexcept;
            void SH2_MOVW(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVW_DISP(U8 DISP, GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVW_IND(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVW_IND_DEC(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVW_IND_INC(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVW_IND_R0(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_MOVW_R0_IND(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            ...
            void SH2_SWAP_BYTE(GP_REGISTER RM, GP_REGISTER RN) noexcept;
            void SH2_SWAP_WORD(GP_REGISTER RM, GP_REGISTER RN) noexcept;
